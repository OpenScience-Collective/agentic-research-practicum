...
| 2. Significance + Innovation + lit expansion | [#37](https://github.com/OpenScience-Collective/agentic-research-practicum/issues/37) | complete (PR #42) | `submission/research-strategy/significance.md`, `innovation.md`, `refs.bib` |
| 3. Approach + preliminary data + timeline | [#38](https://github.com/OpenScience-Collective/agentic-research-practicum/issues/38) | complete (PR #43) | `submission/research-strategy/approach.md`, `figures/` |
| 4. Supplemental sections | [#39](https://github.com/OpenScience-Collective/agentic-research-practicum/issues/39) | complete (PR #44) | Bibliography, Facilities, Equipment, DMS plan, Budget, Biosketches, LoS queue |
| 5. Assembly + grant-review + humanizer | [#40](https://github.com/OpenScience-Collective/agentic-research-practicum/issues/40) | in_progress | `submission/build/r21.pdf` (8pp), `reviews/`, `submission/CHECKLIST.md` |
