<!-- TiCS Abstract. ~80-120 words. No in-text citations.
Filled by manuscript:manuscript-writing in v2 Phase 2.
Skill pattern applied: Abstract Template adapted for narrative review
(Background -> Gap -> Scope -> Synthesis -> Pre-registration). -->
